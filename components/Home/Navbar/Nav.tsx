              ...
              <Link href={link.url} key={link.id}>
                <p
                  className="relative text-white text-base font-medium w-fit block 
                            ...
                            after:w-full after:scale-x-0 after:origin-right after:transition-transform 
                            hover:after:scale-x-100 after:duration-300 after:ease-in-out"
                >
                  {link.label}
                </p>
              </Link>
